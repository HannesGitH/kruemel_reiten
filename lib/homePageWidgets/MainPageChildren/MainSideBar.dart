...
class sideBar extends StatefulWidget{
  ...
  sideBar({@required this.height,this.width=160,this.headHeight=100,this.estKH=35});
      ...
      child: Container(
        ...
        child: Stack(
          ...
          children: <Widget>[
            ...
            Transform.translate(offset: Offset(-50,0),child: GrouplabelColumn(headHeight: widget.headHeight,estKH: widget.estKH,)),
            Transform.translate(
              offset: Offset(0, 0),
                child: IconButton(
